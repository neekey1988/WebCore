...
{
    public class RemoveFileRemoteHttpProvider : RemoveFileBaseProvider, IRemoveFileProvider
    {
        public OptionsRemoveFile options { get; set; }
        private HttpContext context { get; set; }

        public RemoveFileRemoteHttpProvider(HttpContext _context, OptionsRemoveFile _options)
        {
            options = _options;
            context = _context;
        }
