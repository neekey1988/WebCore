...
{
    public class DownloadRemoteHttpProvider : DownloadBaseProvider, IDownloadProvider
    {
        public OptionsDownload options { get; set; }
        private HttpContext context { get; set; }
        private FileExtensionContentTypeProvider mimes { get; set; }

        public DownloadRemoteHttpProvider(HttpContext _context,OptionsDownload _options, FileExtensionContentTypeProvider _mimes)
        {
            options = _options;
            context = _context;
            mimes = _mimes;
